...
/**
 * This class manages the state and behavior of UUID webview panels.
 *
...
export class UUIDPanel {
  ...
  public static render(extensionUri: Uri) {
    if (UUIDPanel.currentPanel) {
      ...
      UUIDPanel.currentPanel._panel.reveal(ViewColumn.One);
    } else {
      ...
      UUIDPanel.currentPanel = new UUIDPanel(panel, extensionUri);
    }
  }
